                ...
                <div
                    ...
                    <a class="navbar-brand" href="index.html">
                        <img src="{{ asset('assets/images/templatemo-barber-logo.png') }}" class="logo-image img-fluid"
                            align="">
                        {{-- <img src="{{ asset('assets/images/templatemo-barber-logo.png') }}" alt=""> --}}
                    </a>
                                ...
                                <form action="#" method="post" class="custom-form booking-form"
                                    ...
                                    <div class="booking-form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <input type="text" name="bb-name" id="bb-name"
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <input class="form-control" type="time" name="bb-time"
                                                    value="18:30" />
                                            </div>

                                            <div class="col-lg-6 col-12">
                                                <select class="form-select form-control" name="bb-branch"
                                                    id="bb-branch" aria-label="Default select example">
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <input type="date" name="bb-date" id="bb-date"
